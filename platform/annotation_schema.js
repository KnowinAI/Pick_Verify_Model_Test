...
const ANNOTATION_SCHEMA = [
  ...
  { key: 'grasp_depth', label: '夹取深度', group: '夹取关系（每张都看）', type: 'select', options: ['浅', '中', '深', '未进入', '不清楚'] },
  ...
  { key: 'reflectiveness', label: '反光程度', shortLabel: '反光', group: '物体属性（字典默认 · 一般不用改）', dict: true, type: 'select', options: ['低反光', '中等反光', '高反光', '不清楚'] },
